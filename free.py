...
if SELECT == "Explore Data":
 ...
 try:
    if 10<=2:
        client = pymongo.MongoClient("mongodb+srv://ms_mgr_007:muthu007@cluster0.dpdtdjk.mongodb.net/?retryWrites=true&w=majority")
        db = client.Airbnb
        col = db.info 
        df = pd.DataFrame(col)
    ...
    os.chdir(r"C:\Users\Muthusamy\Documents\PROJECTS-2023\Airbnb Project")
    df = pd.read_csv("abinfo.csv", encoding="ISO-8859-1")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"MUTHUSAMY G"}')
    mail = (f'{"Mail :"}  {"muthus007gr@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
   
    col1, col2 = st.columns(2)
    col1.image(Image.open(r"C:\Users\Muthusamy\Pictures\Wallpapers\download (3).jpeg"), width=200)
